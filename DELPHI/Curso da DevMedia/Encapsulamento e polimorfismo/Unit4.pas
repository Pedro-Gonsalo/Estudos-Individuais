...
ENCAPSULAMENTO: Encapsular é proteger
  - O que foi feito: para não preencher os dados diretamente nas variáveis, cria-se procedures que pegam esses dados
    e os atribui as variáveis privadas ()

POLIMORFISMO (Várias formas)
  - É a capacidade que a P.O.O. dá de um método se comporta de várias formas dependendo da onde ele foi chamado
...
type
  ...
  protected
  published
    function ExibeDados: String; virtual; abstract; // está aqui para que ele seja modificado pelas classes filhas
