...
(* ANOTAÇÕES
 ...
 - Componente Actionlist = cria ações que podem ser reaproveitadas, por exemplo: o botão fechar e o
fechar do menu fazem a mesma coisa (fecham a aplicação), portanto, ao invés de colocar código no clique
dos dois, é só criar a ação fechar e atribuilá à eles.
